...
export default function BirthdayWish() {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center max-w-screen-2xl flex items-center justify-center p-4" style={{ backgroundImage: "url('/image/bg-color.png')" }} >
      <motion.div
      ...
      >
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-4 border-black  bg-sky-100">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">Happy 17th Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-600">Moiz Qureshi</CardDescription>
